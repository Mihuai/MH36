      ...
      <section className="relative h-[80vh] min-h-[600px] w-full flex items-center justify-center">
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold tracking-tight mb-6 animate-in fade-in slide-in-from-bottom-5 duration-1000">
            Khám phá thế giới cùng <span className="text-primary lg:block mt-2">{settings.companyName}</span>
          </h1>
          <p className="text-lg md:text-xl max-w-2xl mx-auto mb-10 opacity-90 animate-in fade-in slide-in-from-bottom-5 duration-1000 delay-200">
